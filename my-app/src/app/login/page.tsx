      ...
      <Container>
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to continue your Uttarakhand journey</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    type="checkbox"
                    className="rounded border-gray-300 text-[#6B8E6F] focus:ring-[#6B8E6F]"
                  />
                  <span className="ml-2 text-sm text-gray-700">Remember me</span>
                </label>
                <Link href="/forgot-password" className="text-sm text-[#6B8E6F] hover:text-[#5a7a5e] font-medium">
                  Forgot password?
                </Link>
              </div>
              ...
              {/* Social Login Buttons - UPDATED WITH DARK TEXT */}
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/signup" className="text-[#6B8E6F] hover:text-[#5a7a5e] font-semibold">
                  Sign up for free
                </Link>
              </p>
            </div>
